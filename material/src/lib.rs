    ...
    fn default() -> Self {
        ItemPedia {
            types: HashMap::from([
                (
                    0,
                    ItemPedia::matching(leg::Leg::default().item, leg_jp::Leg::default().item),
                ),
                (
                    1,
                    ItemPedia::matching(head::Head::default().item, head_jp::Head::default().item),
                ),
                (
                    2,
                    ItemPedia::matching(
                        chest::Chest::default().item,
                        chest_jp::Chest::default().item,
                    ),
                ),
                (
                    3,
                    ItemPedia::matching(arms::Arms::default().item, arms_jp::Arms::default().item),
                ),
                (
                    4,
                    ItemPedia::matching(
                        waist::Waist::default().item,
                        waist_jp::Waist::default().item,
                    ),
                ),
                (
                    5,
                    ItemPedia::matching(
                        melee::Melee::default().item,
                        melee_jp::Melee::default().item,
                    ),
                ),
                (
                    6,
                    ItemPedia::matching(
                        ranged::Ranged::default().item,
                        ranged_jp::Ranged::default().item,
                    ),
                ),
                (
                    7,
...
impl ItemPedia {
    fn matching<'a>(
        en: HashMap<&'a str, &'a str>,
        jp: HashMap<&'a str, &'a str>,
    ) -> HashMap<&'a str, &'a str> {
